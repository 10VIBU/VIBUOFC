...
/**
 * Download YouTube Video via y2mate.biz
...
async function yt(url, quality, type, bitrate, server = 'id4') {
  ...
  let res = await post(`https://www.y2mate.biz/mates/${server}/analyze/ajax`, {
    url,
    q_auto: 0,
    ajax: 1
  })
  ...
  let res2 = await post(`https://www.y2mate.biz/mates/${server}/convert`, {
    type: 'youtube',
    _id: id[1],
    v_id: ytId[1],
    ajax: '1',
